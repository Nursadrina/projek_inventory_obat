...
// Query ini mengambil semua data dari tabel 'obat'
...
<body>
    <header class="navbar">
        <div class="logo"><i class="fas fa-capsules"></i> Smart Inventory</div>
        <div class="nav-tools">
            <div class="dropdown">
                <button class="dropbtn">
                    <i class="fas fa-user-circle"></i> <?= $_SESSION['nama_pengguna'] ?? 'Petugas'; ?> <i class="fas fa-caret-down"></i>
                </button>
                <div class="dropdown-content">
                    <a href="#" id="logoutBtn" class="logout-link"><i class="fas fa-sign-out-alt"></i> Logout</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="action-bar">
            ...
            <button id="btnTambah" class="btn-main"><i class="fas fa-plus"></i> Tambah Obat Baru</button>
        </div>
        ...
        <div class="table-container">
            <table id="obatTable">
                ...
                <tbody>
                    ...
                    ?>
                    <tr class="<?= ($row['stok'] <= 0) ? 'stok-habis' : '' ?>">
                        <td><?= $row['nama_obat']; ?></td>
                        ...
                        <td>
                            <?php if($row['stok'] > 0): ?>
                                <a href="proses_keluar.php?id=<?= $row['id_obat']; ?>" 
                                   class="btn-keluar" 
                                   onclick="return confirm('Serahkan 1 unit obat ini?')">
                                   <i class="fas fa-hand-holding-medical"></i> Serahkan
                                </a>
                            <?php else: ?>
                                <span class="label-kosong">Stok Habis</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php 
                    ...
                    ?>
                    <tr>
                        <td colspan="5" style="text-align: center; padding: 20px;">Data obat tidak ditemukan.</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <script>
        ...
        // Fitur Real-time Search (DOM Manipulation)
